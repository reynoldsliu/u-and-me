    ...
    try {
        ...
        myGroupList.forEach(group => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <button class="btn btn-outline-success  width: 75px" onclick="window.location.href='http://127.0.0.1:5501/tmp/Front/myGroupListUpdate.html?groupId=${group.group_Id}'" type="button">
