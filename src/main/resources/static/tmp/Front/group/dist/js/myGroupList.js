    ...
    try {
        ...
        myGroupList.forEach(group => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <button class="btn btn-outline-success  width: 75px" onclick="window.location.href='http://localhost:8081/u-and-me/tmp/Front/group/myGroupListUpdate.html?gorupId=${group.group_Id}'" type="button">
