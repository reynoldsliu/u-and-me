    ...
    try {
        ...
        myGroupList.forEach(group => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <button class="btn btn-outline-success  width: 75px" onclick="window.location.href='http://localhost:8080/u-and-me/tmp/Front/group/myGroupListUpdate.html?gorupId=${group.group_Id}'" type="button">
                ...
                <td>
                <button class="btn btn-outline-success id="delete" width: 75px" onclick="deleteGroup(${group.group_Id})" type="button">
